...
from nmt.data import tensorsFromPair
from nmt.utils import asMinutes,timeSince
...
def trainIters(encoder, decoder, pairs, input_lang, output_lang, n_iters, print_every=1000, plot_every=100, learning_rate=0.01,teacher_forcing_ratio=0.5):
    start = time.time()
    plot_losses = []
